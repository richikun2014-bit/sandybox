...
#define WFP_SUBLAYER_DESCRIPTION L"A sublayer used by sandybox to implement internet restrictions"
...
#define WFP_CALLOUT_DESCRIPTION	L"A callout used by sandybox to implement internet restrictions"
...
#define WFP_FILTER_DESCRIPTION L"A filter that uses by sandybox to implement internet restrictions"
